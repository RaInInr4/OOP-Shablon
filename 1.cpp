...
**KISS** (Keep It Simple, Stupid) — «делай проще, глупый». Значит, решение должно быть максимально простым и понятным. Не нужно придумывать сложные конструкции, если можно обойтись очевидным способом.

**YAGNI** (You Aren’t Gonna Need It) — «тебе это не понадобится». Означает, что не надо писать код «на будущее», добавлять функции, которые могут пригодиться когда-нибудь. Пиши только то, что нужно прямо сейчас.

### Ответ выбора
Если нужно выбрать один из двух принципов для начала работы — **начни с KISS**. Потому что сначала важно сделать простое рабочее решение. А YAGNI поможет тебе не усложнять это простое решение лишними деталями «на всякий случай». В идеале используй их вместе: думай просто и не добавляй ненужного заранее.